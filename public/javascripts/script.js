...
function getDataAll(index){        
    ...
    xhr.onload = function (e) {
        ...
        processImageAll(allImages.images[index]);
        processImage2All(allImages.images[index]);
    };
    xhr.send();
...
function analyzeAll(data){
    console.log("Entered analyzeAll");
...
function processImageAll(data) {
  ...
  function processImage2All(data) {
    // **********************************************
    // *** Update or verify the following values. ***
    // **********************************************
